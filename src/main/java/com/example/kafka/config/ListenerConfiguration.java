...
public class ListenerConfiguration {
    ...
    public ListenerConfiguration(@Value("${kafka.broker}") String KAFKA_BROKER,
    ...
    public ConsumerFactory<String, ChatMessage> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(
                consumerConfigurations(), new StringDeserializer(), new JsonDeserializer<>(ChatMessage.class)
        );
    }
